        ...
        <div className=''>
            ...
            <div className='flex justify-between items-center pb-5'>
                <div className='flex gap-3 items-center'>
                    <img className='h-28 cursor-pointer max-sm:hidden' src={assets.logo} alt="" />
                    <img className='h-28 sm:hidden' src={assets.logo_icon} alt="" />
                    <p className='text-[#797484]'>|</p>
                    <p className='text-[#797484]'><span className='max-sm:hidden'>All right reserved. </span>Copyright @AI-Liner</p>
                </div>
                <div className='flex gap-3 items-center'>
